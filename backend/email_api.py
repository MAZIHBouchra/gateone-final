...
# Create FastAPI app
app = FastAPI(title="GateOne Email API", version="1.0.0")
...
@app.post("/send-contact-email", response_model=EmailResponse)
...
async def health_check():
    ...
    return {"status": "healthy", "email_configured": bool(SMTP_USERNAME and SMTP_PASSWORD)}
