...
export default function ClientLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        // Stockage du Token Client spécifique
        localStorage.setItem('gateone_client_token', data.access_token);
        localStorage.setItem('client_name', data.client_name);
        localStorage.setItem('client_id', data.client_id);
        
        alert(`Welcome back to the Circle, ${data.client_name}`);
        navigate('/properties'); // Retour au catalogue avec accès Premium débloqué
      } else {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
               ...
               <div className="space-y-6">
                  ...
                  <div className="space-y-2 pb-6">
                     <label className="text-[9px] uppercase font-bold text-gray-400 tracking-[0.2em] ml-1">Private Security Key</label>
                     <div className="relative group">
